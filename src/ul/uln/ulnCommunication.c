...
/*
 * BUG-44942 SQLPutData(ParamDataIn)의 통신비용을 줄이기 위해 한번에 전송
 *           SQLParamData()의 리턴값이 SQL_NEED_DATA인 경우 Flush를 하지 않기 위해
 *           ulnFinalizeProtocolContext()를 호출하지 않는다. (ulnParamData.c 참고)
 */
