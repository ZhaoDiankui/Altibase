...
/*****************************************************************************
 * $Id: idtBaseThread.cpp 79041 2017-02-20 04:15:43Z yoonhee.kim $
 ****************************************************************************/
...
#define IDE_FN "SInt idtBaseThread::start()"
    ...
    IDE_TEST_RAISE(idtContainer::pop(&sContainer, this) != IDE_SUCCESS, create_error);
    ...
    IDE_TEST_RAISE(sContainer->start() != IDE_SUCCESS, create_error);
