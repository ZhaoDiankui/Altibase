...
/***********************************************************************
 * $Id: idpDescResource.cpp 80559 2017-07-20 06:34:37Z ahra.cho $
 *
 * Description:
 *
 * A3에서 A4로 오면서, 수정된 것.
...
IDE_RC registProperties()
{
    ...
    /*PROJ-2616*/
    IDP_DEF(UInt, "IPCDA_THREAD_INIT_COUNT",
            IDP_ATTR_SL_ALL |
            IDP_ATTR_IU_ANY |
            IDP_ATTR_MS_ANY |
            IDP_ATTR_LC_INTERNAL |
    ...
    // Chunk 하나의 Size 최대값은 64M이나, 
    // Chunk 당 Slot 개수의 최소값으로 Chunk Size 조정이 가능하다.
...
// - iduFile.h 에 그렇게 정의되어 있었음
    ...
    IDP_DEF(UInt, "INDEX_BUILD_THREAD_COUNT",
            ...
            IDP_ATTR_CK_CHECK,
            //fix BUG-19787
            1, 512, IDL_MIN(idlVA::getProcessorCount(), 512));
 ...
 * ----------------------------------------------------------------- */
   ...
   // fix BUG-29384,The upper bound of SQL_PLAN_CACHE_HOT_REGION_LRU_RATIO should be raised up to 100%
    ...
    IDP_DEF( UInt, "REPLICATION_FORCE_CONVERT_APPLY",
             IDP_ATTR_SL_ALL |
             IDP_ATTR_IU_ANY |
             IDP_ATTR_MS_ANY |
             IDP_ATTR_LC_INTERNAL |
