...
typedef struct ideFaultMgr
{
    ...
    ID_FT_VOLATILE idBool     mIsTransientDisable;
    const SChar              *mDisabledEntryFuncName; /* should NULL, if exception section */
    SInt                      mDisabledCallCount;     /* more than 2, if the function is called with IDE_NOFT_BEGIN() recursively */
