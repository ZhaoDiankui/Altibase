                         ...
                         FILE   * a_dbStatsFp )
{
    ...
    IDE_TEST_RAISE(
        SQLBindCol(s_colStmt, 11, SQL_C_SLONG, (SQLPOINTER)&s_nullable, 0,
                   &s_null_ind) != SQL_SUCCESS, col_error);
    ...
    while ( ID_TRUE )
    {
        ...
        getColumnNullable( aDdl, aDdlPos, &s_nullable );
...
/* BUG-40038 [ux-aexport] Needs to consider temporary table in aexport codes */
void getColumnNullable( SChar   * aDdl,
                        SInt    * aDdlPos,
                        SInt    * aIsNullable )
{
#define IDE_FN "getColumnNullable()"
    if ( *aIsNullable == 0 )
    {
        *aDdlPos += idlOS::sprintf( aDdl + *aDdlPos,
                                    " not null" );
